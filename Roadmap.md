...
- **Этап 5 (Социальное)**: 7/7 core задач выполнено (5.1–5.6, 5.10); 5.11 закрыта; smoke test выполнен 20.09; этап не закрыт: периодический review — в работе. Review-бэклог 5.7–5.9, 5.12–5.15 открыт
