...
| 4.7 | [ ] API-эндпоинт тегов — список/поиск существующих тегов (выбор из уже существующих при проставлении айтему) | in_progress (PRD/4.7-tag-list-endpoint.md) |
...
- **Этап 4 (Айтем)**: 5/7 задач выполнено
