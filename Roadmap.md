...
| 4.5 | [ ] API-эндпоинты айтемов (CRUD, список айтемов коллекции, список своих; фильтры по имени и тегам) | in_progress (PRD/4.5-item-api-endpoints.md) |
...
- **Этап 4 (Айтем)**: 4/7 задач выполнено
